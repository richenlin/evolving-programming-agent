...
| **Hermes Agent** | `~/.hermes/skills/` | `./install.sh --hermes` |
...
| **Hermes Agent** | `delegate_task(goal, context)` | 内置 delegate_task 工具，子 agent 独立上下文 |
...
[Hermes Agent] delegate_task(goal="审查 review_pending 任务", context="...")
