...
│  │                  四大核心 Skills                             │      │
│  ├─────────────────────────────────────────────────────────────┤      │
│  │ 1. github-to-skills    - GitHub 仓库学习器                    │      │
│  │ 2. skill-manager       - 插件生命周期管理器                    │      │
│  │ 3. skill-evolution-mgr - 经验进化管理器                        │      │
│  │ 4. programming-assistant - 全栈开发助手                       │      │
│  └─────────────────────────────────────────────────────────────┘      │
│                                │                                         │
│                                ▼                                         │
│  ┌─────────────────────────────────────────────────────────────┐      │
...
│  │  7 大分类知识存储系统:                                        │      │
│  │  • experience  - 项目经验积累                                 │      │
│  │  • tech-stack  - 技术栈知识 (React, Koatty等)                 │      │
│  │  • scenario    - 场景知识 (创建项目、修复bug等)                │      │
│  │  • problem     - 问题解决 (CORS跨域、内存泄漏等)               │      │
│  │  • testing     - 测试知识                                     │      │
│  │  • pattern     - 编程范式 (IOC、AOP等)                         │      │
│  │  • skill       - 编程技能                                     │      │
│  ├─────────────────────────────────────────────────────────────┤      │
│  │  智能索引系统:                                                  │      │
│  │  • trigger_index - 关键字触发映射                               │      │
│  │  • category_index - 分类索引                                    │      │
│  └─────────────────────────────────────────────────────────────┘      │
│                                │                                         │
│                                ▼                                         │
...
│  │                   异步子会话层                                  │      │
│  ├─────────────────────────────────────────────────────────────┤      │
│  │  • knowledge-retrieval  - 知识检索 (不阻塞主任务)              │      │
│  │  • knowledge-summarize  - 知识归纳与总结                       │      │
│  │  • knowledge-trigger    - 智能触发检测                         │      │
│  └─────────────────────────────────────────────────────────────┘      │
│                                │                                         │
│                                ▼                                         │
│  ┌─────────────────────────────────────────────────────────────┐      │
...
├────────────────────────────────────────────┤
│ 建议操作:                                    │
│ 1. 运行 `/skill-manager update yt-dlp-tool`  │
│    更新                                     │
